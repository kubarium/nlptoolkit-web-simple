...
import turkishDictionary from "@/data/turkish/turkish-dictionary.json"
import { reactive, ref } from 'vue'

defineOptions({ meta: { language: "Turkish", toolkit: "Dictionary" } })
...
function findWord(word) {
  ...
  for (let i = 0; i < turkishDictionary.length; i++) {
    ...
    if (wordName === word) {
      ...
      searchResult.value = display;
      return
    }
  }
  searchResult.value = "Bu kelime sözlükte yok";
}
</script>
