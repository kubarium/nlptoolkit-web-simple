...
import turkishWordNet from "@/data/turkish/turkish-wordnet-0.json"
import turkishWordNet from "@/data/turkish/turkish-wordnet-1.json"
import turkishWordNet from "@/data/turkish/turkish-wordnet-2.json"
import turkishWordNet from "@/data/turkish/turkish-wordnet-3.json"
import turkishWordNet from "@/data/turkish/turkish-wordnet-4.json"
import turkishWordNet from "@/data/turkish/turkish-wordnet-5.json"
import turkishWordNet from "@/data/turkish/turkish-wordnet-6.json"
import turkishWordNet from "@/data/turkish/turkish-wordnet-7.json"
import turkishWordNet from "@/data/turkish/turkish-wordnet-8.json"
import turkishWordNet from "@/data/turkish/turkish-wordnet-9.json"
...
<template>
    <header class="uk-flex uk-flex-around uk-background-default" uk-sticky uk-grid>
        <SearchForm @submit.prevent="findFrame(searchTerms.word)" v-model="searchTerms.word">Word</SearchForm>
        <SearchForm @submit.prevent="findVerb(searchTerms.synonym)" v-model="searchTerms.synonym">Synonym</SearchForm>
            ...
            <div class="uk-accordion-content">
                ...
                <div uk-grid>
                    <div class="uk-width-2-3">
                        <span class="uk-label uk-margin-xsmall-right" v-for="frame in result.frameElements"
                            :key="frame">
                            {{ frame }}
                        </span>
                    </div>
                ...
                <table class="uk-table uk-table-striped uk-table-hover uk-table-small">
                    ...
                    <tbody>
                        <tr v-for="unit in result.lexicalUnits" :key="unit">
                            ...
                            <td>
                                <template v-for="(word, index) in utils.searchInWordnet(unit, turkishWordNet)['words']"
                                    :key="word">
